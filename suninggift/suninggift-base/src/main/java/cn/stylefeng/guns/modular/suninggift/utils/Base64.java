...
public class Base64 {
    ...
    public static Object decode(Object pObject) throws UnsupportedEncodingException {
        if (!(pObject instanceof byte[])) {
            throw new UnsupportedEncodingException("Parameter supplied to Base64 decode is not a byte[]");
        }
    ...
    public static Object encode(Object pObject) throws UnsupportedEncodingException {
        if (!(pObject instanceof byte[])) {
            throw new UnsupportedEncodingException("Parameter supplied to Base64 encode is not a byte[]");
        }
