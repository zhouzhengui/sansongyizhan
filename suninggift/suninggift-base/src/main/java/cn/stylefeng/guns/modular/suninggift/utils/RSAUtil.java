...
public class RSAUtil {
    ...
    /**
     * 生成RSA密钥对
     * @param  encryptType  待加密类型
     * @param  charset      加密字符集
     * @return base64格式的密钥对
     */
	public static Map<String, String> generateKeyPair(String encryptType, String charset) 
			throws Exception {
		...
		int keySize = 0;
		if(ENCRYPT_TYPE_RSA2.equals(encryptType)){
			kpg = KeyPairGenerator.getInstance(ENCRYPT_TYPE_RSA2);
			keySize = RSA2_KEYSIZE;
		}else { /** 默认生成RSA */
			kpg = KeyPairGenerator.getInstance(ENCRYPT_TYPE_RSA);
			keySize = RSA_KEYSIZE;
		}
     ...
     * @param  charset      待加密字符集
     * @return base64格式的密文
     */
	public static String encrypt(String clearString, String publicKey, String charset) 
			throws Exception {
		charset = charset == null ? CHARSET : charset;
		...
		return new String(Base64.encodeBase64(cipherBytes), charset);
	}
     ...
     * @param  publicKey    公钥base64串
     * @param  charset 待解密字符集
     * @return 加密前明文
     */
	public static String decrypt(String cipherString, String privateKey, String charset)
			throws Exception {
		charset = charset == null ? CHARSET : charset;
	...
	public static String sign(String content, String signType, String privateKey, String charset) 
		...
		if(ENCRYPT_TYPE_RSA2.equals(signType)){
	 ...
	 * @throws Exception 
     */
	public static boolean checkSign(String content, String sign, String signType, String publicKey, String charset) 
			throws Exception {
		charset = charset == null ? CHARSET : charset;
		KeyFactory keyFactory = KeyFactory.getInstance("RSA");
