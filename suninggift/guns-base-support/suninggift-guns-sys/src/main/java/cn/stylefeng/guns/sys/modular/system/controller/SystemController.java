...
public class SystemController extends BaseController {
     ...
     * @Date 2018/12/24 22:43
     */
    @RequestMapping("/agencyIndex")
    public String agencyIndex() {
        return "/modular/frame/agency_index.html";
    }
     ...
     * @Date 2018/12/24 22:43
     */
    @RequestMapping("/agencyStoreManage")
    public String agencyStoreManage() {
        return "/modular/frame/agency_store_manage.html";
    }
     ...
     * @Date 2018/12/24 22:43
     */
    @RequestMapping("/agencyTradeManage")
    public String agencyTradeManage() {
        return "/modular/frame/agency_trade_manage.html";
    }
