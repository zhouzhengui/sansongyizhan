...
import cn.stylefeng.guns.modular.suninggift.aop.ApiSignInterceptor;
...
public class WebConfig implements WebMvcConfigurer {
    ...
    @Bean
    public HandlerInterceptor getJwtAuthenticationFilter(){
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(new ApiSignInterceptor()).addPathPatterns("/tmall/**");
        registry.addInterceptor(getJwtAuthenticationFilter()).addPathPatterns("/**");
