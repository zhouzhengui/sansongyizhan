...
/**
 * 客户资料校验和身份证认证（实名认证 + 一证五户验证）
 */
public class HaokaOpennewCheckIdentityCustTest {
...
//  private static final String md5Key = "Yy112j...!!jh128921@po1nn811009a";
  ...
  public static void main(String[] args) throws IOException {
    ...
    requestParams.put("method", "haoka.opennew.check.identity.cust");
